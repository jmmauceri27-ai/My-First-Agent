...
const ASSIGNMENT_COLUMNS =
  "id, site_id, trade, vendor_id, sub_vendor_id, contract_id, contract_value, sub_price, sub_vendor_price, vendor:vendors!site_trade_assignments_vendor_id_fkey(name), sub_vendor:vendors!site_trade_assignments_sub_vendor_id_fkey(name), contract:crm_contracts(name, billing_type)";
