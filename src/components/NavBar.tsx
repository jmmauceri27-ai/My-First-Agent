...
export default function NavBar() {
  ...
  return (
    <header className="sticky top-0 z-10 border-b border-blue-500/15 bg-[#05070d]/85 backdrop-blur-md">
      <div className="h-1 bg-gradient-to-r from-brand-700 via-brand-400 to-sky-300" />
