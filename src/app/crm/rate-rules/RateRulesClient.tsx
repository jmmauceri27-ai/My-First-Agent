        ...
        <div className="flex items-center justify-between gap-3">
          <div>
            ...
            <p className="text-xs text-slate-400">
              Labor, equipment, materials, and flat-rate service items -- a proposal&rsquo;s price for a trade is
              composed from these, not a single number.
            </p>
          </div>
      ...
      <div className="flex flex-col gap-2">
        <div className="flex items-center justify-between gap-3">
          <div>
            ...
            <p className="text-xs text-slate-400">
              A specific client&rsquo;s blanket discount or markup on one trade&rsquo;s computed total -- applied on
              top of that trade&rsquo;s rate items above.
            </p>
          </div>
